...
public class CarLocalCombined {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Tuple4GL<String, String, LidarImageContainer.Annotation3D, Long>> pedestrians = LidarLeftRightTimestamped
                ...
                .name("PedestrianFilter"+settings.queryID());
        ...
        settings
                ...
                .activate(
                        ...
                        Arrays.asList("CYCLES", "PEDESTRIANS"),
                        settings,
                        settings.queryU(),
                        timestampConverter,
                        env.getConfig());

        env.execute("CarLocalCombined queryID" + settings.queryID());
    }
