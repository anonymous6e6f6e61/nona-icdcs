...
public class VehicleAggregateGL
    implements AggregateFunction<LinearRoadInputTupleGL, VehicleAggregateGL.VehicleAccumulator, VehicleTupleGL> {

  private final Supplier<ProvenanceAggregateStrategy> aggregateStrategySupplier;

  public VehicleAggregateGL(Supplier<ProvenanceAggregateStrategy> aggregateStrategySupplier) {
