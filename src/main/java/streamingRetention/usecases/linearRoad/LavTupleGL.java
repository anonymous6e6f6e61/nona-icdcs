...
public class LavTupleGL extends LavTuple implements GenealogTuple {

    private GenealogData gdata;

    public LavTupleGL(long timestamp, String key, long stimulus, double lav) {
        super(timestamp, key, stimulus, lav);
    }
