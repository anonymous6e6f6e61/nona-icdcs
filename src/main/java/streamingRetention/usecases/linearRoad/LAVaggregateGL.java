...
public class LAVaggregateGL implements AggregateFunction<
        LavTupleGL,
        LAVaggregateGL.SpeedAccumulator,
        LavTupleGL> {

    private final Supplier<ProvenanceAggregateStrategy> aggregateStrategySupplier;

    public LAVaggregateGL(Supplier<ProvenanceAggregateStrategy> strategy) {
