...
public class StatsEcg2Average
        implements AggregateFunction<MhealthInputTupleGL, StatsEcg2Average.StatsAverageAccumulator,
        Tuple2GL<Double, String>> {

    private final Supplier<ProvenanceAggregateStrategy> aggregateStrategySupplier;

    public StatsEcg2Average(
    ...
    public static class StatsAverageAccumulator
        ...
        public void doAdd(MhealthInputTupleGL tuple) {
            ...
            key = tuple.getKey();
            ecgReadings.add(tuple.getEcgSignalLead2());
        }
