...
CLASS="streamingRetention.usecases.linearRoad.queries.LinearRoadAccident"
U=150000
...
add ACCIDENTS0 "${CLASS}" "${U}" "${WORKER1FLINK_BIN}" "${WORKER1JAR}" "${WORKER1SSH_PREFIX}" "${WORKER1ROOT}"
sleep 60
add ACCIDENTS1 "${CLASS}" "${U}" "${WORKER2FLINK_BIN}" "${WORKER2JAR}" "${WORKER2SSH_PREFIX}" "${WORKER2ROOT}"
sleep 60
add ACCIDENTS2 "${CLASS}" "${U}" "${WORKER3FLINK_BIN}" "${WORKER3JAR}" "${WORKER3SSH_PREFIX}" "${WORKER3ROOT}"
sleep 60
add ACCIDENTS3 "${CLASS}" "${U}" "${WORKER1FLINK_BIN}" "${WORKER1JAR}" "${WORKER1SSH_PREFIX}" "${WORKER1ROOT}"
sleep 60
add ACCIDENTS4 "${CLASS}" "${U}" "${WORKER2FLINK_BIN}" "${WORKER2JAR}" "${WORKER2SSH_PREFIX}" "${WORKER2ROOT}"
sleep 60
add ACCIDENTS5 "${CLASS}" "${U}" "${WORKER3FLINK_BIN}" "${WORKER3JAR}" "${WORKER3SSH_PREFIX}" "${WORKER3ROOT}"
sleep 60
add ACCIDENTS6 "${CLASS}" "${U}" "${WORKER1FLINK_BIN}" "${WORKER1JAR}" "${WORKER1SSH_PREFIX}" "${WORKER1ROOT}"
sleep 60
add ACCIDENTS7 "${CLASS}" "${U}" "${WORKER2FLINK_BIN}" "${WORKER2JAR}" "${WORKER2SSH_PREFIX}" "${WORKER2ROOT}"
sleep 60
add ACCIDENTS8 "${CLASS}" "${U}" "${WORKER3FLINK_BIN}" "${WORKER3JAR}" "${WORKER3SSH_PREFIX}" "${WORKER3ROOT}"
sleep 60

remove ACCIDENTS0 "${WORKER1FLINK_BIN}" "${WORKER1SSH_PREFIX}" "${WORKER1ROOT}"
sleep 60
remove ACCIDENTS1 "${WORKER2FLINK_BIN}" "${WORKER2SSH_PREFIX}" "${WORKER2ROOT}"
sleep 60
remove ACCIDENTS2 "${WORKER3FLINK_BIN}" "${WORKER3SSH_PREFIX}" "${WORKER3ROOT}"
sleep 60
remove ACCIDENTS3 "${WORKER1FLINK_BIN}" "${WORKER1SSH_PREFIX}" "${WORKER1ROOT}"
sleep 60
remove ACCIDENTS4 "${WORKER2FLINK_BIN}" "${WORKER2SSH_PREFIX}" "${WORKER2ROOT}"
sleep 60
remove ACCIDENTS5 "${WORKER3FLINK_BIN}" "${WORKER3SSH_PREFIX}" "${WORKER3ROOT}"
sleep 60
remove ACCIDENTS6 "${WORKER1FLINK_BIN}" "${WORKER1SSH_PREFIX}" "${WORKER1ROOT}"
sleep 60
remove ACCIDENTS7 "${WORKER2FLINK_BIN}" "${WORKER2SSH_PREFIX}" "${WORKER2ROOT}"
sleep 60
remove ACCIDENTS8 "${WORKER3FLINK_BIN}" "${WORKER3SSH_PREFIX}" "${WORKER3ROOT}"
sleep 60
